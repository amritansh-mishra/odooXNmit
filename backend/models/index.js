...
// REMOVED Payment associations - not used in active functionality
...
Contact.hasMany(PurchaseOrder, { foreignKey: 'vendor_id' });
PurchaseOrder.belongsTo(Contact, { foreignKey: 'vendor_id' });
...
module.exports = {
  ...
  VendorBill,
  Invoice,
  // Payment, // REMOVED - not used in active functionality
  Counter,
};
